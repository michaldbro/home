...
lista_produktow = [ #słownik
    ...
    {"nazwa": "karta graficzna",
     "marka": "radeon",
     "ilosc": 5,
    }
]

historia_operacji = ["zakup procesorow, intel, 5szt.", "zakup plyt glownych, msi, 5szt.", "zakup kart graficznych, radeon, 5szt."]
