...
rain_in_file = file_handler.search_in_file(value)
print(file_handler.search_in_file(value))

if rain_in_file is not None:
    rain = rain_in_file.get("rain", [])
    city = rain_in_file.get("city", [])
    if value == rain and value_2 == city:
